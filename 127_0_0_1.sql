...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 05, 2022 at 12:57 AM
...
(4, 'a', 'b', '2', 'POÁ', '11980347658', 'asd');
--
-- Database: `pynpinbd`
--
CREATE DATABASE IF NOT EXISTS `pynpinbd` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `pynpinbd`;
...
--
-- Table structure for table `tb_cores`
--
...
--
-- Table structure for table `tb_detalhescarrinhos`
--
...
CREATE TABLE IF NOT EXISTS `tb_produtos` (
  ...
  `Imagem2Produto` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Imagem3Produto` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Imagem4Produto` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Constraints for table `tb_carrinhos`
--
...
--
-- Constraints for table `tb_detalhescarrinhos`
--
